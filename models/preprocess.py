                ...
                with open(file_path, 'r') as f:
                    for line in f:
                        ...
                        for i in range(len(ids) - 1):
                            input_ids = [1] + ids[i] + [2]  # 添加BOS和EOS
                            target_ids = [1] + ids[i + 1] + [2]  # 添加BOS和EOS
...
preprocess_data('dataset/dataset_json/train_set', 'train_data.json')
preprocess_data('dataset/dataset_json/validation_set', 'validation_data.json')
